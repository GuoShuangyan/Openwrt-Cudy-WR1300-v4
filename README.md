...
![Firmware Upgrade](固件升级.png)

![Browse](浏览.png)

![Upload Official Firmware](上传官方固件.png)
...
![Select Again - 1](再次选择-1.png)

![Select Again - 2](再次选择-2.png)

![Select Again - 3](再次选择-3.png)

![Select Again - 4](再次选择-4.png)

![Select Again - 5](再次选择-5.png)

![Select Again - 6](再次选择-6.png)

Do not keep any configuration here — uncheck the checkbox. Then click "Continue" to proceed with the upgrade.

![Select Again - 7](再次选择-7.png)
...
![WiFi Lights Not Working](WiFi灯不正常.png)
...
![WiFi Lights Working](WiFi灯正常.png)
